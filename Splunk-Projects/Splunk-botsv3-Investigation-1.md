...
This project serves as a learning resource for myself, reinforcing core security principles and best practices, and gaining hands on experience with industry standard tools. I will be investigating the data sources included with the attack dataset, outlined here. [Sources]()
...
Sysmon is a Windows utility that logs system activity, including process creation, file changes, network connections, and more. It's valuable for detecting attacker behavior at the host level. This is a great starting place for my first investigation into the attack dataset from botsv3. 
